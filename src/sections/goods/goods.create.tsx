...
export function GoodsCreateForm({ stores, storeId }: { stores: StoreType[]; storeId: string }) {
          ...
          <Grid container spacing={3}>
            ...
            <Grid xs={12} md={12} lg={12}>
              <TextField
                fullWidth
                label="商铺"
                value={stores.find((s) => s.store_id === formik.values.store_id)?.store_name || ""}
                disabled
              />
              <input type="hidden" name="store_id" value={formik.values.store_id} />
            </Grid>
            <Grid xs={12} md={12} lg={12}>
              <FormControl variant="filled" fullWidth>
                <InputLabel htmlFor="category_id">分类 *</InputLabel>
                <Select
                  native
                  required
                  displayEmpty
                ...
                <Paper>
                  <Grid container spacing={2}>
                    <Grid xs={12} md={6} lg={6}>
                      <FormControl variant="filled" fullWidth>
                        <InputLabel htmlFor="unit_name">单位名称 *</InputLabel>
                        <Select
                          native
                          required
